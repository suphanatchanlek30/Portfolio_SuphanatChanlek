...
const Navbar = () => {
  return (
    <nav className="bg-black text-white px-4 py-4 border-b border-[#212429]">
      <div className="container mx-auto flex items-center justify-between">
        {/* Logo/Brand */}
        <div className="text-[24px] font-semibold">
          <Link href="/" className="hover:text-gray-300 transition-colors font-manrope">
            Suphanat
          </Link>
        </div>

        {/* Navigation Links */}
        <div className="hidden md:flex items-center space-x-14 font-inter font-light text-[16px]">
          <Link 
            href="/" 
